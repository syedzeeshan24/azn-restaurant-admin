...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-40 px-10 py-6 flex justify-between items-center bg-dark-deep/80 backdrop-blur-md">
      ...
      <div className="flex items-center space-x-10">
        <div className="flex items-center space-x-4 cursor-pointer group">
          ...
          <div className="w-12 h-12 rounded-2xl overflow-hidden border-2 border-white/5 group-hover:border-brand-light/50 transition-all shadow-xl">
             <img 
